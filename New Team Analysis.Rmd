...
all_team_data <- all_team_data %>%
  ...
  mutate(
    ...
    team_close_win_gen_rate = ifelse(team_games_sum == 0, NA, round(team_close_win_sum / team_wins_sum, 3)),
...
1.  Model 1: Home/Away, Average Offensive Rating, Average Defensive Rating
