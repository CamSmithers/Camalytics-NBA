...
go2_table <- table(ma_all_team_data$my_predicted_win, ma_all_team_data$team_game_outcome_2)
print(go2_table)
...
fd_table <- table(ma_all_team_data$team_favored, ma_all_team_data$team_game_outcome_2)
print(fd_table)
