...
shaded_region_2 <- data.frame(
  x = c(50, 50, 65, 65),
  y = c(50, 100, 100, 50))

shaded_region_3 <- data.frame(
  x = c(50, 50, 65, 65),
  y = c(19.2, 25, 25, 25))

shaded_region_4 <- data.frame(
  x = c(65, 65, 100, 100),
  y = c(25, 50, 50, 38.5))

shaded_region_5 <- data.frame(
  x = c(50, 50, 65, 65),
  y = c(25, 50, 50, 25))

shaded_region_6 <- data.frame(
  x = c(65, 65, 100, 100),
  y = c(50, 100, 100, 50))
```
...
daily.outcome_plot_1 <- ggplot(daily.team_visual_data,
                               aes(x = winloss_predicted_values,
                                   ...
                                   color = team_name)) + 
    geom_polygon(data = shaded_region, aes(x = x, y = y), 
                 fill = "lightgreen", alpha = 0.1, inherit.aes = FALSE) + 
    geom_polygon(data = shaded_region_2, aes(x = x, y = y), 
                 fill = "grey", alpha = 0.2, inherit.aes = FALSE) +
    geom_polygon(data = shaded_region_3, aes(x = x, y = y), 
                 fill = "yellow", alpha = 0.2, inherit.aes = FALSE) +
    geom_polygon(data = shaded_region_4, aes(x = x, y = y), 
                 fill = "yellow", alpha = 0.2, inherit.aes = FALSE) +
    geom_polygon(data = shaded_region_5, aes(x = x, y = y), 
                 fill = "orange", alpha = 0.2, inherit.aes = FALSE) +
    geom_polygon(data = shaded_region_6, aes(x = x, y = y), 
                 fill = "grey", alpha = 0.2, inherit.aes = FALSE) +
...
all.outcome_plot_1 <-  ggplot(all.team_visual_data, 
    ...
    scale_x_continuous(limits = c(50, 100)) + 
    theme_classic() +
    facet_grid(team_team~nba_picks_factor) +
    labs(
...
historic.outcome_plot_3 <- ggplot(historic.team_visual_data, 
