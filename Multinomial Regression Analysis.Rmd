...
all_team_data <- all_team_data %>%
    ...
    mutate(team_game_outcome_3 = ifelse(team_plusminus > 10| team_plusminus < -10, 1, 0))
...
-   Model
    ...
    -   Team Game Outcome (TGO) 1: 4 Level Multinomial Regression
...
## TGO 2: Win/Loss Logistic Regression

```{r}
model_one <- glm(team_game_outcome_2 ~ team_home
...
# Team Game Outcome 3: Outcome Magnitude
